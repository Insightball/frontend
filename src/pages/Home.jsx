...
const LANG = {
  FR: {
    ...
    // Hero
    heroTitle1: 'Chaque match',
    heroTitle2: 'mérite d\'être',
    heroTitle3: 'analysé.',
    heroSub: 'Filme ton match. Reçois ta ',
    heroSubBold: 'data',
    heroSubEnd: ' — heatmaps, stats joueurs, tendances tactiques.',
  ...
  EN: {
    ...
    heroTitle2: 'deserves to be',
    heroTitle3: 'analyzed.',
    heroSub: 'Film your match. Get your ',
    heroSubBold: 'data',
    heroSubEnd: ' — heatmaps, player stats, tactical trends.',
