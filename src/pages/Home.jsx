    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-3 group shrink-0">
              <div className="relative">
                ...
                <div className="relative w-10 sm:w-12 h-10 sm:h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center shrink-0">
                  <svg className="w-6 sm:w-7 h-6 sm:h-7 text-black" viewBox="0 0 24 24" fill="none">
            ...
            <div className="hidden lg:flex items-center gap-6 ml-auto">
              ...
              <Link to="/signup" className="px-4 sm:px-6 py-2 sm:py-2.5 bg-gradient-to-r from-emerald-500 to-teal-500 text-black font-semibold rounded-lg hover:shadow-lg hover:shadow-emerald-500/50 transition-all whitespace-nowrap shrink-0 text-sm sm:text-base">
                Essayer gratuitement
              </Link>
            </div>

            {/* Mobile CTA */}
            <Link to="/signup" className="lg:hidden px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-black font-semibold rounded-lg text-sm whitespace-nowrap">
              Essayer
            </Link>
          </div>
        </div>
      ...
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 -left-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-emerald-500/20 rounded-full blur-3xl animate-pulse parallax" data-speed="0.3"></div>
          <div className="absolute bottom-1/4 -right-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-teal-500/20 rounded-full blur-3xl animate-pulse parallax" data-speed="0.5" style={{ animationDelay: '1s' }}></div>
          ...
          {/* Floating elements */}
          <div className="absolute top-20 left-10 w-2 h-2 bg-emerald-500 rounded-full animate-ping" style={{ animationDuration: '3s' }}></div>
          <div className="absolute top-40 right-20 w-3 h-3 bg-teal-500 rounded-full animate-ping" style={{ animationDuration: '4s', animationDelay: '1s' }}></div>
          <div className="absolute bottom-20 left-1/4 w-2 h-2 bg-cyan-500 rounded-full animate-ping" style={{ animationDuration: '5s', animationDelay: '2s' }}></div>
        </div>

        <div className="relative max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-emerald-500/10 border border-emerald-500/30 rounded-full mb-6 sm:mb-8 animate-fade-in">
              <Sparkles className="w-4 h-4 text-emerald-400 animate-pulse" />
              <span className="text-xs sm:text-sm text-emerald-400 font-medium">Pour les coachs & éducateurs</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up px-4" style={{ animationDelay: '0.4s' }}>
              <Link 
                to="/signup" 
                className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-black font-semibold rounded-xl hover:shadow-2xl hover:shadow-emerald-500/50 transition-all flex items-center justify-center space-x-2"
              >
            ...
            <div className="mt-12 sm:mt-16 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-gray-500 animate-fade-in-up px-4" style={{ animationDelay: '0.6s' }}>
              ...
              <div className="flex items-center space-x-2">
                <CheckCircle2 className="w-4 sm:w-5 h-4 sm:h-5 text-emerald-500" />
                <span className="text-xs sm:text-sm">Analyse en 24h</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 relative">
        <div className="max-w-7xl mx-auto">
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-gray-900 to-black border-2 border-emerald-500/30 rounded-2xl overflow-hidden shadow-2xl">
              <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                <div className="text-center p-6 sm:p-8">
                  <BarChart3 className="w-12 sm:w-16 h-12 sm:h-16 mx-auto mb-4 text-emerald-500" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-teal-500/10 border border-teal-500/30 rounded-full mb-6">
              ...
              <span className="text-xs sm:text-sm text-teal-400 font-medium">Fonctionnalités</span>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {/* Feature 1 */}
            <div className="group relative p-6 sm:p-8 bg-gradient-to-b from-white/5 to-transparent border border-white/10 rounded-2xl hover:border-emerald-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="w-12 sm:w-14 h-12 sm:h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                  <Camera className="w-6 sm:w-7 h-6 sm:h-7 text-black" />
                </div>
            ...
            <div className="group relative p-6 sm:p-8 bg-gradient-to-b from-white/5 to-transparent border border-white/10 rounded-2xl hover:border-emerald-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="w-12 sm:w-14 h-12 sm:h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                  <Clock className="w-6 sm:w-7 h-6 sm:h-7 text-black" />
                </div>
            ...
            <div className="group relative p-6 sm:p-8 bg-gradient-to-b from-white/5 to-transparent border border-white/10 rounded-2xl hover:border-emerald-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="w-12 sm:w-14 h-12 sm:h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                  <FileText className="w-6 sm:w-7 h-6 sm:h-7 text-black" />
                </div>
            ...
            <div className="group relative p-6 sm:p-8 bg-gradient-to-b from-white/5 to-transparent border border-white/10 rounded-2xl hover:border-emerald-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="w-12 sm:w-14 h-12 sm:h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                  <Users className="w-6 sm:w-7 h-6 sm:h-7 text-black" />
                </div>
            ...
            <div className="group relative p-6 sm:p-8 bg-gradient-to-b from-white/5 to-transparent border border-white/10 rounded-2xl hover:border-emerald-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <div className="relative">
                <div className="w-12 sm:w-14 h-12 sm:h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                  <Shield className="w-6 sm:w-7 h-6 sm:h-7 text-black" />
                </div>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 relative">
        <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-6 sm:p-8 bg-gradient-to-b from-emerald-500/10 to-transparent border border-emerald-500/20 rounded-2xl hover:transform hover:scale-105 transition-all">
              <div className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent mb-2 animate-pulse">
                98%
              </div>
              <div className="text-sm sm:text-base text-gray-400">Précision de l'analyse</div>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-b from-emerald-500/10 to-transparent border border-emerald-500/20 rounded-2xl hover:transform hover:scale-105 transition-all">
              <div className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent mb-2 animate-pulse" style={{ animationDelay: '0.5s' }}>
                &lt;24h
              </div>
              <div className="text-sm sm:text-base text-gray-400">Temps d'analyse</div>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gradient-to-b from-emerald-500/10 to-transparent border border-emerald-500/20 rounded-2xl hover:transform hover:scale-105 transition-all">
              <div className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent mb-2 animate-pulse" style={{ animationDelay: '1s' }}>
                100%
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-6 sm:p-8 bg-gradient-to-b from-white/5 to-transparent border border-white/10 rounded-2xl hover:transform hover:scale-105 transition-all">
              ...
              <div className="flex items-baseline gap-3 mb-2">
                <span className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">29€</span>
              ...
              <div className="inline-block px-3 py-1 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-medium rounded-full mb-6">
                -41% - Offre limitée
              </div>
            ...
            {/* Plan Club */}
            <div className="relative p-6 sm:p-8 bg-gradient-to-b from-emerald-500/10 to-transparent border-2 border-emerald-500/50 rounded-2xl hover:transform hover:scale-105 transition-all">
              <div className="absolute top-0 right-4 sm:right-6 -translate-y-1/2 px-3 sm:px-4 py-1 bg-gradient-to-r from-emerald-500 to-teal-500 text-black text-xs sm:text-sm font-bold rounded-full">
                POPULAIRE
              </div>
              <h3 className="text-xl sm:text-2xl font-bold mb-2">Plan CLUB</h3>
              <div className="flex items-baseline gap-3 mb-2">
                <span className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">99€</span>
              ...
              <Link to="/signup" className="block w-full text-center px-6 sm:px-8 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-black font-semibold rounded-lg hover:shadow-lg hover:shadow-emerald-500/50 transition-all text-sm sm:text-base">
                Commencer
              </Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="flex items-start space-x-4">
                <div className="w-10 sm:w-12 h-10 sm:h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-lg flex items-center justify-center shrink-0">
                  <Mail className="w-5 sm:w-6 h-5 sm:h-6 text-black" />
                </div>
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-1">Email</h3>
                  <a href="mailto:contact@insightball.com" className="text-sm sm:text-base text-gray-400 hover:text-emerald-400 transition-colors">
              ...
              <div className="flex items-start space-x-4">
                <div className="w-10 sm:w-12 h-10 sm:h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-lg flex items-center justify-center shrink-0">
                  <Phone className="w-5 sm:w-6 h-5 sm:h-6 text-black" />
                </div>
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-1">Téléphone</h3>
                  <a href="tel:+33123456789" className="text-sm sm:text-base text-gray-400 hover:text-emerald-400 transition-colors">
                    +33 1 23 45 67 89
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-10 sm:w-12 h-10 sm:h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-lg flex items-center justify-center shrink-0">
                  <MapPin className="w-5 sm:w-6 h-5 sm:h-6 text-black" />
                </div>
                <div>
            ...
            <form onSubmit={handleContactSubmit} className="space-y-4 sm:space-y-6 p-6 sm:p-8 bg-gradient-to-b from-white/5 to-transparent border border-white/10 rounded-2xl">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black border border-white/10 rounded-lg px-4 py-2 sm:py-3 text-sm sm:text-base text-white placeholder-gray-500 focus:border-emerald-500 focus:outline-none transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-black border border-white/10 rounded-lg px-4 py-2 sm:py-3 text-sm sm:text-base text-white placeholder-gray-500 focus:border-emerald-500 focus:outline-none transition-colors resize-none"
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center space-x-2 px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-black font-semibold rounded-lg hover:shadow-lg hover:shadow-emerald-500/50 transition-all text-sm sm:text-base"
              >
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative p-8 sm:p-12 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-3xl overflow-hidden hover:transform hover:scale-105 transition-all">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-transparent"></div>
            <div className="relative">
              <Target className="w-12 sm:w-16 h-12 sm:h-16 text-emerald-400 mx-auto mb-4 sm:mb-6 animate-bounce" />
              ...
              <Link 
                to="/signup" 
                className="inline-flex items-center space-x-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-black font-semibold rounded-xl hover:shadow-2xl hover:shadow-emerald-500/50 transition-all text-sm sm:text-base"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-8 sm:w-10 h-8 sm:h-10 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-lg flex items-center justify-center">
                  <svg className="w-5 sm:w-6 h-5 sm:h-6 text-black" viewBox="0 0 24 24" fill="none">
